...
import '../data/create_service_class.dart';
import '../data/search_particular_service.dart';
...
class _CreateserviceState extends State<Createservice> {
  ...
  Searchclass searchservice = Searchclass();
  // snapshot (data) that return from the search
